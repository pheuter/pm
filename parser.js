  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_Array(context) {
        ...
        var result0 = result1 !== null
          ? (function(items) { var i = []; var s = []; items.forEach(function (v) {v.forEach(function (val) { if(val.type) { i.push(val.value); s.push(val.show);}});}); return {type:"ARRAY", show: "{"+s+"}",value:i};})(result1[1])
          : null;
